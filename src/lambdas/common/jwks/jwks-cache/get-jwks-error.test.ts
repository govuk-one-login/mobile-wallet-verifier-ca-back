...
describe('InMemoryJwksCache - Errors', () => {
  ...
  describe('getJwks', () => {
    describe('Given an HTTP network error occurs', () => {
      ...
      it('Logs MOBILE_CA_GET_JWKS_FAILURE with JWKS URI', () => {
        expect(consoleErrorSpy).toHaveBeenCalledWithLogFields({
          messageCode: 'MOBILE_CA_GET_JWKS_FAILURE',
          data: {
    ...
    describe('Given status code is not 200', () => {
      ...
      it('Logs MOBILE_CA_MALFORMED_JWKS_RESPONSE with JWKS URI', () => {
        expect(consoleErrorSpy).toHaveBeenCalledWithLogFields({
          messageCode: 'MOBILE_CA_MALFORMED_JWKS_RESPONSE',
          data: {
            jwksUri: 'mock_jwks_uri',
          },
        });
